    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            while (!salir)
            {
                ...
                {
                    case ("1"):
                        List<Double> lista = TomarDosNumeros();
                        int Suma = Convert.ToInt32(lista[0]) + Convert.ToInt32(lista[1]);
                        Console.WriteLine("EL RESULTADO ES: " + Suma);
                        Console.WriteLine("");
                        break;

                    case ("2"):
                        List<Double> lista2 = TomarDosNumeros();
                        int resta = Convert.ToInt32(lista2[0]) - Convert.ToInt32(lista2[1]);
                        Console.WriteLine("EL RESULTADO ES: " + resta);
                        Console.WriteLine("");
                        break;

                    case ("3"):
                        List<Double> lista3 = TomarDosNumeros();
                        int mult = Convert.ToInt32(lista3[0]) * Convert.ToInt32(lista3[1]);
                        Console.WriteLine("EL RESULTADO ES: " + mult);
                        Console.WriteLine("");
                        break;

                    case ("4"):
                        List<Double> lista4 = TomarDosNumeros();
                        int div = Convert.ToInt32(lista4[0]) + Convert.ToInt32(lista4[1]);
                    ...
                    default:
                        Console.WriteLine("");
                        Console.WriteLine("La opcion \"" + Opcion0 + "\" no es valida");
                        Console.WriteLine("Ingrese un número que esté en el Menú");
                        Console.WriteLine("");
                        Console.WriteLine("");
                        break;
        ...
        static List<Double> TomarDosNumeros()
        {
            Console.WriteLine("");
            ...
            return new List<Double> { numero, numero2 };
        }
